...
package org.minbox.framework.resource.context;
...
public class ResourceContext {
     ...
     * logger instance
     */
    static Logger logger = LoggerFactory.getLogger(ResourceContext.class);
    ...
    public static Field getPushFieldFromCache(String declaredFieldClassName, String fieldName) {
        ...
        Field field = ResourceContext.RESOURCE_FIELDS.get(cacheKey);
        return field;
    }
    ...
    public static void setPushFieldToCache(String declaredFieldClassName, String fieldName, Field field) {
        ...
        ResourceContext.RESOURCE_FIELDS.put(cacheKey, field);
    }
    ...
    public static List<ResourceField> getResourceFieldFromCache(Method method) {
        ...
        return ResourceContext.RESOURCE_FIELD_ANNOTATIONS.get(methodName);
    }
    ...
    public static void setResourceFieldToCache(Method method, List<ResourceField> resourceFields) {
        ...
        ResourceContext.RESOURCE_FIELD_ANNOTATIONS.put(methodName, resourceFields);
    }
