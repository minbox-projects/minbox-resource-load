 ...
 *
 */
package org.minbox.framework.resource.aop.advistor;
 ...
 * @author 恒宇少年
 */
public class ResourceLoadAdvisor extends AbstractPointcutAdvisor implements BeanFactoryAware {

    private Advice advice;
    private Pointcut pointcut;
    private BeanFactory beanFactory;

    public ResourceLoadAdvisor(ResourceLoadMethodInterceptor apiBootResourceLoadMethodInterceptor) {
