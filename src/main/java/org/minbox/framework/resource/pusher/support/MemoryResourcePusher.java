 ...
 * @author 恒宇少年
 */
public class MemoryResourcePusher extends JdbcResourcePusher {
    /**
     * logger instance
     */
    static Logger logger = LoggerFactory.getLogger(MemoryResourcePusher.class);
    /**
     * memory resource urls
     */
    private Map<String, List<String>> RESOURCE_URLS = new HashMap();

    public MemoryResourcePusher(ResourceStoreDelegate resourceStoreDelegate) {
        super(resourceStoreDelegate);
    }
    ...
    public List<String> loadResourceUrl(Method declaredMethod, String sourceFieldValue, String resourceType) {
        ...
        // formatter key
        String resourceKey = ResourceContext.formatterCacheKey(declaredMethod, sourceFieldValue, resourceType);
        // get resource urls
