...
public abstract class AbstractResourcePusher implements ResourcePusher {
     ...
     */
    @Override
    public void insertResource(Method declaredMethod, Object[] param) throws ResourceLoadException {
     ...
     */
    @Override
    public void deleteResource(Method declaredMethod, Object[] param) throws ResourceLoadException {
        // get method declared ResourceField annotations
        List<ResourceField> resourceFields = ResourceFieldTools.getResourceFields(declaredMethod);
        resourceFields.stream().forEach(resourceField -> {
            // get expression match source filed value
     ...
     */
    @Override
    public void updateResource(Method declaredMethod, Object[] param) throws ResourceLoadException {
        // get method declared ResourceField annotations
        List<ResourceField> resourceFields = ResourceFieldTools.getResourceFields(declaredMethod);
        resourceFields.stream().forEach(resourceField -> {
            // get expression match source filed value
