 ...
 * @author 恒宇少年
 */
public class RedisResourcePusher extends JdbcResourcePusher {
    /**
     * logger instance
     */
    static Logger logger = LoggerFactory.getLogger(RedisResourcePusher.class);
    ...
    public RedisResourcePusher(ResourceStoreDelegate apiBootResourceStoreDelegate, RedisTemplate redisTemplate) {
    ...
    public List<String> loadResourceUrl(Method declaredMethod, String sourceFieldValue, String resourceType) {
        ...
        // formatter redis key
        String resourceRedisKey = ResourceContext.formatterCacheKey(declaredMethod, sourceFieldValue, resourceType);
        // get resource size
